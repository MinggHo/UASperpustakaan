...
Public Class laporanpinjaman
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UASperpustakaan.laporanpinjaman.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlaporanpinjaman
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As laporanpinjaman = New laporanpinjaman()
        rpt.Site = Me.Site
        Return rpt
    End Function
